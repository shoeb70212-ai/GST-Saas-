# LedgerLens — Product Vision

## The Pivot
This project originated as **PayForce**, a legal enforcement and collections tool for MSMEs aimed at using GST laws (Rule 37, Section 34, MSMED Act) to force buyers to pay. 
However, after market evaluation, we pivoted to **LedgerLens** — an AI-powered GST Invoice Scanner and Multi-Tenant Accountant Workspace. 
...
LedgerLens acts as an automated, multi-tenant digital workspace for accountants. 
