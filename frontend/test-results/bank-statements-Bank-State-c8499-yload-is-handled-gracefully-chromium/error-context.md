...
- Name: bank-statements.spec.ts >> Bank Statements UI & Edge Cases >> Edge Case 1: Empty Data payload is handled gracefully
- Location: e2e\bank-statements.spec.ts:16:3
...
Locator: locator('h1:has-text("Bank Statements")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Bank Statements")')
