...
- Name: bank-reconcile.spec.ts >> Bank Reconciliation Dashboard Edge Cases >> Edge Case 2: Server 500 Error handles gracefully with Toast
- Location: e2e\bank-reconcile.spec.ts:40:3
...
Locator: locator('h1:has-text("Bank Reconciliation")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Bank Reconciliation")')
