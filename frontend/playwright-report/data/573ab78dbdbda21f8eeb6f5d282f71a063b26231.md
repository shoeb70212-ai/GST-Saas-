...
- Name: bank-reconcile.spec.ts >> Bank Reconciliation Dashboard Edge Cases >> Happy Path & Edge Case 3: Network Latency on Engine Run
- Location: e2e\bank-reconcile.spec.ts:64:3
...
Locator: locator('text=/Test Supplier/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Test Supplier/i').first()
